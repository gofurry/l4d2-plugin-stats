...
Version 0.6.0 adds separate absolute snapshots for human Versus survivor and
...
incapacitations, and kills split by human/Bot survivor targets. These snapshots
share the existing bounded closure queues and asynchronous flush transaction but
never enter the PvE statistics tables.
