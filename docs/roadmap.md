...
当前稳定版本为 `v1.2.1`。SourceMod 采集器使用 Stats schema 3 / `stats_version = 1`，支持 SQLite、MySQL 和 PostgreSQL；稳定版 Dashboard 使用 schema 10，当前开发版使用 schema 11，Aggregate Contract 仍为 v1。详细版本变化统一记录在 [`CHANGELOG.md`](../CHANGELOG.md)。
