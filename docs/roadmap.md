...
当前稳定版本为 `v1.2.0`。SourceMod 采集器使用 Stats schema 3 / `stats_version = 1`，支持 SQLite、MySQL 和 PostgreSQL；Dashboard 使用 schema 9 和 Aggregate Contract v1。详细版本变化统一记录在 [`CHANGELOG.md`](../CHANGELOG.md)。
