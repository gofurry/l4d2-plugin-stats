...
Dashboard 已完成 Go + 内嵌 React 地基、公开首页、多服务器 A2S、Steam OpenID、个人查询、单管理员后台、管理员运行监控、完整个人统计、全服排行榜、增量聚合与安全保留工具。当前版本为 `v1.1.0`。
...
8. 稳定版本遵循语义化版本规则；不在源码、默认构建或正式交付包中使用开发版本后缀。
