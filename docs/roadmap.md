...
当前版本为 `v1.3.2`。SourceMod 采集器使用 Stats schema 6 / `stats_version = 1`，支持 SQLite、MySQL 和 PostgreSQL；Dashboard 使用 schema 16，Aggregate Contract 与 Achievement Contract 均为 v1。详细版本变化统一记录在 [`CHANGELOG.md`](../CHANGELOG.md)。
