...
export interface SiteSettings { language: SiteLanguage; browser_title: string; theme: SiteTheme; footer_enabled: boolean; background_image_url: string; public_origin: string; steam_openid_enabled: boolean; steam_openid_proxy_port?: number; a2s_refresh_seconds: number; a2s_jitter_seconds: number; a2s_retry_count: number; seo_enabled: boolean; seo_description: string; seo_image_url: string; footer_links: FooterLink[] }
