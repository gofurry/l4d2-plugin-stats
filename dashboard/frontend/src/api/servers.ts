...
export interface ServerStatus { server_id: string; server_key?: string; display_name: string; address: string; online: boolean; stale: boolean; checking: boolean; name?: string; map?: string; players: number; max_players: number; bots: number; latency_ms?: number; last_success_at?: string; checked_at: string; player_list?: ServerPlayer[]; rules?: ServerRule[] }
