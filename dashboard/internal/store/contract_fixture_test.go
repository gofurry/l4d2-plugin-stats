...
func insertContractFixture(t *testing.T, db *sql.DB) {
	...
	w := contractWatermark
	statements := []string{
		fmt.Sprintf(`INSERT INTO lps_schema_migrations (version,name,applied_at) VALUES (1,'initial',%d),(2,'car_alarms_triggered',%d),(3,'versus_objective_interactions',%d),(4,'analysis_foundation',%d),(5,'relationships_and_assists',%d)`, b, b+1, b+2, b+3, b+4),
